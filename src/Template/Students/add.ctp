        ...
        <div class="col-md-12">
            ...
            <div id="wizar">
                ...
                <div class="wizard-step-1">
                    <fieldset>
                        <legend class="pull-left width-full">OLD AND RETURNING STUDENT</legend>
                        <!-- begin row -->
                        <div class="row">
                            <!-- begin col-4 -->
                            <div class="col-md-12">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                echo $this->Form->input('school_id', ['options' => $schools ,'id'=>'school']);
                                echo $this->Form->input('level_id', ['options' => $levels,'id' => 'level']);
                                ?>
