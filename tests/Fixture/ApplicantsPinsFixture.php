...
/**
 * ApplicantsPinsFixture
 *
 */
class ApplicantsPinsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'status' => ['type' => 'integer', 'length' => 15, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'pins' => ['type' => 'index', 'columns' => ['pin'], 'length' => []],
        ],
        '_constraints' => [
