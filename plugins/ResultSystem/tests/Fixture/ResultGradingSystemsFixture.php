...
class ResultGradingSystemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'score' => ['type' => 'integer', 'length' => 5, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-09-15 21:24:56',
            'modified' => '2016-09-15 21:24:56'
        ],
    ];
}
