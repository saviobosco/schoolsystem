...
class StudentAnnualResultsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('first_term', 'create')
            ->notEmpty('first_term');
    ...
    {
        /*if ( $event->data['entity']['third_term'] ) {
            $entity->total = $event->data['entity']['first_term'] + $event->data['entity']['second_term'] + $event->data['entity']['third_term'] ;
        }*/
        Log::debug($event);
    }
