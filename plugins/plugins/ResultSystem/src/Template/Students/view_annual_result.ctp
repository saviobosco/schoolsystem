                        ...
                        <table class="table table-bordered ">
                            ...
                            <?php foreach ($student->student_annual_results as $studentAnnualResults): ?>
                                <tr>
                                    ...
                                    <td><?= $this->Form->postLink(__('Delete'), ['action' => 'deleteAnnualStudentResultRow', $studentAnnualResults->id,'?'=>$queryData], ['confirm' => __('Are you sure you want to delete this subject score ?')]) ?> </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
                    <?php endif; ?>
